...
from async_sendgrid.sendgrid import AsyncClient
...
class TestAsyncClient:
    ...
    def _setup(self, httpx_mock: HTTPXMock) -> None:
        ...
        self._service = AsyncClient(api_key=secret_key, impersonate_subuser=impersonate_subuser)
    ...
    def test_constructor(self, mock_create_session) -> None:
        ...
        Test constructor.
        """
        assert self._service.endpoint == "https://api.sendgrid.com/v3/mail/send"
